...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    <div class="container">
        <a class="navbar-brand text-white" href="{{ route('donor#index') }}">Merry meal</a>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <li class="nav-item">
                <a class="nav-link active text-white" aria-current="page" href="{{ route('donor#index') }}">Home</a>
            </li>
            </ul>
            ...
            <div class="btn-group btn-outline-secondary">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('donor#updateDonor') }}">Update </a></li>
                    <li>
